...
<!-- Upload as dialog -->
<div id="upload-overlay" class="overlay" hidden role="dialog" aria-modal="true" aria-label="Upload image">

<!-- Filter chips with aria-pressed -->
<button class="filter-chip" aria-pressed="false" data-key="collection" data-value="Gold">Gold</button>
